...
CATS={
 "finance":["asset-allocation","average-down","bond-yield","break-even","break-even-units","cagr","compound-interest","compound-interest-debt","confidence-interval","correlation-calculator","dca-calculator","dcf-calculator","debt-to-equity","dividend-yield","ebitda-valuation","future-value","inflation","intrinsic-value","irr-calculator","margin-calculator","payback-period","pb-ratio","pe-ratio","position-size","present-value","probability-calculator","regression-calculator","risk-reward","roi-calculator","rule-of-72","sample-size","sharpe-ratio","simple-interest","standard-deviation","stock-gain-loss","stop-loss","weighted-average"],
 "mortgage":["cap-rate","cash-on-cash","down-payment","home-affordability","home-equity","home-mortgage","mortgage","mortgage-refinance","property-tax","refinance-break-even","rent-vs-buy","rental-yield","stamp-duty"],
 "loan":["0-percent-financing","apr-calculator","balloon-payment","business-loan-calc","car-loan","credit-card-payoff","credit-score-impact","debt-consolidation","debt-to-income","extra-payment","heloc-vs-personal-loan","loan-affordability","loan-comparison","loan-vs-lease","ltv-calculator","payday-loan-cost","personal-loan-calc","student-loan","student-loan-refi"],
 "tax":["bonus-tax","capital-gains-tax","effective-tax-rate","freelancer-tax","income-tax","payroll-tax","rental-income-tax","vat-calculator"],
 "insurance":["business-insurance","car-insurance-calc","coverage-gap-finder","critical-illness-calc","dental-cost-calculator","disability-insurance","health-insurance-estimate","home-insurance-calc","income-replacement","insurance-premium-compare","liability-insurance","life-insurance-calc","life-insurance-needs","pet-insurance-calc","renters-insurance","roi-of-insurance","term-vs-whole-life","travel-insurance-calc","umbrella-insurance"],
 "health":["baby-growth","bac-calculator","blood-pressure-chart","bmi-calculator","bmr-calculator","body-fat-calculator","caffeine-calculator","calorie-calculator","glycemic-load","heart-rate-zone","ideal-weight","lean-body-mass","macro-calculator","one-rep-max","ovulation-calculator","pace-calculator","pregnancy-due-date","protein-calculator","sleep-calculator","sodium-calculator","tdee-calculator","vitamin-calculator","waist-hip-ratio","water-intake"],
 "trading":["atr-calculator","bollinger-bands","candlestick-identifier","fibonacci-retracement","forex-profit","kelly-criterion","ma-crossover","macd-calculator","options-profit","pip-value","pivot-point","rsi-calculator","stock-split","support-resistance","trading-fee"],
 "business":["amazon-profit","burn-rate-calculator","business-exit-value","cbm-calculator","churn-rate","company-registration","container-load","conversion-rate","customer-acquisition","customs-duty","dimensional-weight","dropship-margin","email-roi","employee-cost","eps-calculator","equity-dilution","fba-fee-calculator","franchise-roi","gross-profit-margin","inventory-turnover","landed-cost","markup-margin","mrr-calculator","net-profit-margin","pallet-calculator","pricing-calculator","roas-calculator","runway-calculator","saas-ltv-cac","shipping-cost","shopee-profit","startup-cost-estimator","startup-valuation","valuation-calculator","working-capital","youtube-revenue"],
 "retirement":["401k-contribution","annuity-calculator","annuity-income","catch-up-contribution","coast-fire-calc","fire-number-calc","pension-vs-lump-sum","required-minimum-dist","retirement","retirement-age","retirement-income-need","retirement-savings-gap","roth-vs-traditional","withdrawal-rate"],
 "construction":["asphalt-calculator","brick-calculator","concrete-calculator","deck-calculator","drywall-calculator","fence-calculator","flooring-calculator","gravel-calculator","insulation-calculator","lumber-calculator","metal-weight","paint-calculator","pipe-weight","pool-volume","rebar-calculator","renovation-cost","roof-area","room-area","staircase-calculator","steel-weight","tile-calculator","wallpaper-calculator","window-size"],
 "auto":["bike-gear-ratio","car-depreciation","car-insurance-calc","car-insurance-estimate","car-lease-vs-buy","car-loan","commute-cost","engine-horsepower","ev-charging-cost","ev-range","ev-vs-gas","fuel-cost","fuel-efficiency","gas-bill","gear-ratio","tire-size","trip-fuel"],
 "cooking":["bread-hydration","calorie-density","coffee-ratio","cooking-converter","cooking-weight-volume","food-cost","meat-cooking-time","oven-converter","pizza-dough","recipe-scaler","serving-size","sourdough-calculator"],
 "education":["class-rank","college-savings","final-grade","flashcard-spacing","gpa-calculator","grade-calculator","ielts-band","reading-time","scholarship-calculator","student-loan","study-time","toefl-ielts","tuition-cost","typing-speed"],
 "utility":["age-calculator","air-conditioner-size","appliance-energy","battery-calculator","bolt-torque","carbon-footprint","cost-of-living","currency-converter","date-difference","denier-calculator","electricity-cost","fabric-shrinkage","generator-size","gsm-converter","home-energy-audit","land-area-converter","led-savings","ohms-law","paper-weight","parking-cost","percentage-calculator","solar-panel-count","solar-roi","speed-distance-time","temperature-converter","time-zone-converter","tip-calculator","water-bill","word-count","yarn-weight"],
 "career-salary":["ab-test-significance","annual-leave","freelance-rate","influencer-rate","meeting-cost","minimum-wage","overtime-calculator","overtime-limit","salary-raise","salary-to-hourly","sales-commission","take-home-pay","work-days"],
